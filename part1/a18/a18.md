...
However when following the NASA link we encounter a 404 page not found error.

![NASA 404 Error](chatgpt-404-error.png)

This is an example of AI hallucination in which false references are generated when searching for academic sources about scientific concepts.

## 2) ChatGPT – Hallucinates Out-of-Date Statistics When Reviewing World Records
